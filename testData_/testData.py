...
# User Credentials
validUser = User("lianasargsyan202@gmail.com", "tracemalloc2023")
userWithInvalidPassword = User("lianasargsyan202@gmail.com", "abcdef")
userWithInvalidUserName = User("lianasargsyan202@mail.ru", "tracemalloc2023")
